-- // KAT! KILL ALL GUI \\
-- // ORIGINALLY MADE BY: Noul1 \\
-- // GREATLY IMPROVED BY: NOLIX \\

-- // PLEASE NOTE: YOU MUST HAVE YOUR WEAPONS LOADED AND THE KNIFE NOT EQUIPPED IF YOU WANT THE SCRIPT TO WORK \\
...
Credits2.Text = "Improved by: Nolix on WRD"
...
Credits1.Text = "Original by: BaconLord#0001"
